        ...
        <div className="bg-gray-800 p-4 rounded-lg shadow-md space-y-4">
            ...
            <div className="flex gap-2">
                <div className="flex-1">
                    <label className="text-xs text-gray-400">Address (Hex)</label>
                    <div className="flex items-center gap-2">
                        ...
                        <input
                            ...
                            className="bg-gray-900 border border-gray-700 rounded p-2 text-white w-full font-mono"
                        />
                    </div>
                </div>
                <div className="flex-1">
                    <label className="text-xs text-gray-400">Data (Dec)</label>
                    <input
                        type="number"
                        value={dataInput}
            ...
            <div className="flex gap-1 text-center text-xs font-mono mt-2">
                <div className="flex-1 bg-yellow-900/50 p-1 rounded border border-yellow-700" title="Tag">
                    <div className="text-yellow-400 font-bold">{formatBinary(breakDown.tag, breakDown.tagBits)}</div>
                    <div className="text-gray-400">Tag ({breakDown.tagBits})</div>
                </div>
                <div className="flex-1 bg-green-900/50 p-1 rounded border border-green-700" title="Index">
                    <div className="text-green-400 font-bold">{formatBinary(breakDown.index, breakDown.indexBits)}</div>
                    <div className="text-gray-400">Index ({breakDown.indexBits})</div>
                </div>
                <div className="flex-1 bg-blue-900/50 p-1 rounded border border-blue-700" title="Offset">
                    <div className="text-blue-400 font-bold">{formatBinary(breakDown.offset, breakDown.offsetBits)}</div>
                    <div className="text-gray-400">Offset ({breakDown.offsetBits})</div>
                </div>
            </div>
